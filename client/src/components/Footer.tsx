...
export function Footer() {
  ...
  const handleNewsletterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Attempt to save to the database API endpoint
      try {
        ...
        console.warn("Failed to save newsletter to database - proceeding with mailto redirect", dbError);
      }

      const subject = encodeURIComponent("Newsletter Subscription Request");
      const body = encodeURIComponent(`Please subscribe my email to your newsletter.\n\nEmail: ${email}`);
      ...
      toast({
        ...
        description: "Your email client has been opened to send this subscription request.",
      });
      setEmail("");
    } catch (error) {
      toast({
